...
final class ExamResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_open_other_apps_allowed' => $this->is_open_other_apps_allowed,
            ...
            'exam_reading_materials' => ExamReadingMaterialResource::collection($this->whenLoaded('examReadingMaterials')),
